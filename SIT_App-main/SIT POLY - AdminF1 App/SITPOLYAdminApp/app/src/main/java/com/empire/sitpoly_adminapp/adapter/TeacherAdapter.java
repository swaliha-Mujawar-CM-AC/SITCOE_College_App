...
import com.empire.sitpoly_adminapp.faculty.UpdateTeacherActivity;
...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.TeacherViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull TeacherViewAdapter holder, int position) {
        ...
        try {
            Picasso.get().load(item.getImage()).placeholder(R.drawable.ic_launcher_background).into(holder.imageView);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static class TeacherViewAdapter extends RecyclerView.ViewHolder {
        ...
        public TeacherViewAdapter(@NonNull View itemView) {
            ...
            update = itemView.findViewById(R.id.update_info_btn);
